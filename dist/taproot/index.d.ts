...
export declare const tapLeaf: (script: WizData, version: string) => string;
export declare const controlBlockCalculation: (scripts: WizData[], version: string, innerkey: string, lookupLeafIndex: number) => string;
