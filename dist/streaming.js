...
var sha256streaming_1 = require("@bitmatrix/sha256streaming");
var sha256Finalizer = function (wizData, wizData2) {
    var result = sha256streaming_1.sha256straming.sha256Finalizer(wizData.hex, wizData2.hex);
...
var sha256Updater = function (wizData, wizData2) {
    var result = sha256streaming_1.sha256straming.sha256Updater(wizData.hex, wizData2.hex);
    return wiz_data_1.default.fromHex(result);
};
exports.sha256Updater = sha256Updater;
var sha256Initializer = function (wizData) {
    var result = sha256streaming_1.sha256straming.sha256Initializer(wizData.hex);
    return wiz_data_1.default.fromHex(result);
};
